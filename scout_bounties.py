...
def format_issue_title(count):
    """Format the GitHub issue title with correct English pluralization."""
...
def format_notification_message(new_bounties, now_str):
    """Format Telegram/Discord notification message with correct pluralization."""
...
def format_issue_body(new_bounties, now_str):
    """Format the GitHub issue body with scan results."""
    issue_body = (
