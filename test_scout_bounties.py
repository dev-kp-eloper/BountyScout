"""Unit tests for BountyScout triage logic, notification builders, and persistence."""
...
class TestBountyScout(unittest.TestCase):
    ...
    def test_is_clean_candidate_filters_recursive_alerts(self):
        ...
        scan_body_item = dict(self.valid_item, body="### Active Bounty Scan Results\n\nScan details...")
        self.assertFalse(is_clean_candidate(scan_body_item))
    ...
    def test_pluralize_opportunity(self):
        """Verify singular and plural opportunity strings."""
        ...
        self.assertEqual(pluralize_opportunity(17, capitalize=True), "Opportunities")
    ...
    def test_format_issue_title_plural(self):
        ...
        title_large = format_issue_title(17)
        self.assertEqual(title_large, "🎯 Bounty Alert: 17 New Opportunities found")
        self.assertNotIn("Opportunityies", title_large)
    ...
    def test_format_notification_message_singular_and_plural(self):
        ...
        self.assertEqual(build_notification_markdown(single_bounty, now_str="2026-08-29 12:00 UTC"), msg_single)
    ...
    def test_format_issue_body(self):
        ...
        payload_title, payload_body = build_github_issue_payload(bounties, now_str="2026-08-29 12:00 UTC")
        content_title, content_body = format_github_issue_content(bounties, now_str="2026-08-29 12:00 UTC")
        self.assertEqual(payload_title, "🎯 Bounty Alert: 1 New Opportunity found")
        self.assertEqual(payload_title, content_title)
        self.assertEqual(payload_body, body)
        self.assertEqual(payload_body, content_body)
