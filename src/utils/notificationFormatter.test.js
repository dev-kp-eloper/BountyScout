...
describe('formatBountyNotification', () => {
  ...
  test('formats multiple opportunities correctly', () => {
    expect(formatBountyNotification(19)).toBe('🎯 Bounty Alert: 19 New Opportunities found');
  ...
  test('throws error for invalid input', () => {
    ...
    expect(() => formatBountyNotification('19')).toThrow('Count must be a non-negative number');
